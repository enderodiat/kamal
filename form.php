			...
			<div class="row">
				...
				<div id="userType" class="col-sm-4 offset-sm-4">
					<div class="custom-control custom-radio">
					  <input type="radio" id="typeAgenteCultural" name="userType" value="agentCultural" class="custom-control-input" data-parsley-errors-container="#userTypeError" data-parsley-class-handler="#userType" required>
